			...
			<div className="h-fit w-full ">
				<div className=" lg:w-9/12 w-5/6 mx-auto rounded-md flex flex-col gap-3 lg:px-5 ">
					<div className="my-auto mx-auto flex flex-col gap-10  ">
						<h1 className="lg:text-8xl text-6xl mx-auto lg:mx-0 bg-gradient-to-r from-blue-300 to-black text-transparent bg-clip-text py-3 pr-3 font-oswald italic tracking-tight font-semibold lg:text-left">
							Our Vision
						</h1>
					</div>
