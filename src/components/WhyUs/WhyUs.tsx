			...
			<div className="h-fit ">
				<div className=" lg:w-9/12 w-5/6 mx-auto rounded-md flex flex-col gap-2 lg:px-5 ">
					<div className="lg:my-auto mx-auto flex flex-col gap-10  ">
						<h1 className="lg:text-8xl md:text-7xl text-6xl bg-gradient-to-r from-blue-300 to-black text-transparent bg-clip-text py-3 pr-3 font-oswald tracking-tight font-semibold text-left">
							Why Us ?
						</h1>
					</div>
