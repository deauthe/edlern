...
`;
export const policyText: string = `Privacy Policy
We value your trust. In order to honour that trust, edLern adheres to ethical standards in gathering,
using, and safeguarding any information you provide. Edlern Innovations Private Limited (operating
under the brand name edLern), is a leading edtech company, incorporated in India, for imparting
learning. This privacy policy governs your use of the application EdLern, www.edLern.com
(‘Website’) and the other associated applications, products, websites and services managed by the
Company. Please read this privacy policy (‘Policy’) carefully before using the Application, Website,
our services and products, along with the Terms of Use (‘ToU’) provided on the Application and the
...
products including through SD cards, tablets or other storage/transmitting device shall signify your
...
The Application/Website/Services/products obtains the information you provide when you
...
‘Information’ in this Policy. We may use the Information to contact you from time to time, to provide
you with the Services, important information, required notices and marketing promotions. We will
ask you when we need more information that personally identifies you (personal information) or
allows us to contact you. We will not differentiate between who is using the device to access the
Application, Website or Services or products, so long as the log in/access credentials match with
yours. In order to make the best use of the Application/Website/Services/products and enable your
Information to be captured accurately on the Application/Website/Services/products, it is essential
that you have logged in using your own credentials. We will, at all times, provide the option to you
to not provide the Personal Information or Sensitive Personal Information, which we seek from you.
...
that you provide. We use an outside credit card processing company to bill you for goods and
services. These companies do not retain, share, store or use personally identifiable information for
any other purpose.
At the time you (on behalf of yourself and/or your ward) register with us for our Services or during
the term of Services relating to our products/services/subscriptions, we may require camera and
microphone access while you avail such products/services/subscriptions to improve the in-classroom
experience. All video, audio and telecalls between you/your ward and our
educators/representatives/agents are recorded for quality and training purposes. These recordings
shall not be shared with you/your ward for any reasons whatsoever. By agreeing to this Privacy
Policy, you (on behalf of yourself and/or your ward) consent to our collection/ recording and use of
your and/or your ward’s audio/video/telecall recordings and personal information for the above-
mentioned purposes.
...
behaviour about our user base as a whole. Aggregated and individual, anonymized and non-
anonymized data may periodically be transmitted to external service providers to help us improve
the Application, products and our Services. We will share your information with third parties only in
the ways that are described below in this Policy. We may use the individual data and behaviour
patterns combined with personal information to provide you with personalized content, and better
your learning objectives. Third parties provide certain services which we may use to analyze the data
and information to personalize, drive insights and help us better your experience or reach out to you
with more value-added applications, products, information and services. However, these third-party
companies do not have any independent right to share this information. We do not sell, trade or
share your Information to any third party (except subsidiaries/affiliates of the Company for related
offerings) unless, we have been expressly authorized by you either in writing or electronically to do
...
aggregate form and does not contain any of your Personally Identifiable Information. edLern will
occasionally send email notices, messages or contact you to communicate about our Services,
...
safety or the safety of others, investigate fraud, address security or technical issues or
...
Application/Website/ Edlern Innovations Private Limited or its users or the public as
...
 Any portion of the Information containing personal data relating to minors provided by you
shall be deemed to be given with the consent of the minor’s legal guardian. Such consent is
deemed to be provided by your registration with us.
...
measures to protect your password from being exposed or disclosed to anyone.
Cookies
...
more content in areas of greater interest to a majority of users. Most browsers are initially set up to
accept cookies, but you can reset your browser to refuse all cookies or to indicate when a cookie is
being sent. Some of our features and services may not function properly if your cookies are disabled.
Links
...
Alerts
We may alert you by email or phone (through sms/call/whatsapp) to inform you about new service
offerings of the Company and its subsidiaries/affiliates or other information which we feel might be
useful for you, through the Company or its subsidiaries/affiliates.
Public Forums
When you use certain features on our website like the discussion forums and you post or share your
...
information in order to operate, develop or improve our Application/Services/products/Website.
Please be aware that, although we endeavour to provide reasonable security for information we
...
needed to free up storage space.
Log information
When you access our website, our servers automatically record information that your browser sends
whenever you visit a website. These server logs may include information such as your web request,
internet protocol address, browser type, browser language, the date and time of your request and
one or more cookies that may uniquely identify your browser.
User communications
When you send an email or other communication to us, we may retain those communications in
order to process your inquiries, respond to your requests and improve our Services.
Changes to this Statement
As the Company evolves, our privacy policy will need to evolve as well to cover new situations. You
...
transferred, processed and stored in accordance with the applicable data protection laws of India.
Contact Information
Reach out to us on support@edlern.com, in case of any queries.`;
