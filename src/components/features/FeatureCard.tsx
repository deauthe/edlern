...
export const HoverEffect = ({
	...
	return (
		<div
			className={cn(
				"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-4  py-10",
				className
			)}
		>
			{items.map((item, idx) => (
...
export const Card = ({
	...
	return (
		<div
			className={cn(
				"rounded-2xl h-full w-full p-4 overflow-hidden bg-blue-300  group-hover:border-slate-700 relative z-20",
				className
			)}
		>
