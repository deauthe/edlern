export const FeatureCardContent: {
...
}[] = [
	{
		...
		description: (
			<ul className="font-rajdhani tracking-wider font-normal w-5/6 text-left mx-auto list-disc ">
	...
	},
	{
		title: "Study Rooms",
		description: (
			<ul className=" font-rajdhani tracking-wider font-normal text-left w-5/6 mx-auto list-disc ">
	...
	},
	{
		title: "Gamification",
		description: (
			<ul className=" font-rajdhani tracking-wider font-normal text-left w-5/6 mx-auto list-disc flex flex-col gap-2">
