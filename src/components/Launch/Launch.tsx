			...
			<div className="h-fit ">
				<div className=" lg:w-9/12 w-5/6 mx-auto rounded-md flex flex-col gap-3 lg:px-5 ">
					<div className="my-auto mx-auto flex flex-col gap-10  ">
						<h1 className="uppercase lg:text-7xl text-5xl md:text-6xl mx-auto lg:mx-0 text-black py-3  font-oswald  tracking-tight font-semibold text-center flex flex-col gap-5">
